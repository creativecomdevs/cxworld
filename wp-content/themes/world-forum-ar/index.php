...
<main class="main">
    ...
    <section class="promo" id="promo">
        ...
        <div class="container">
            ...
            <div class="promo__dates">
                ...
                <button class="promo__button"><a href="/ar/?add-to-cart=15">سجل الآن</a>
                </button>
                <div class="promo__date">
                    <div class="promo__span"><span>2024 &nbsp;</span><span>يناير</span><span>&nbsp;25 - 24</span></div>
                    الرياض - قاعة ذا أرينا حي غرناطة
                </div>
                <div class="promo__payment">لا حاجة للدفع</div>
            </div>
        </div>
    </section>
    ...
    <div class="forum-schedule-wrapper">
                        ...
                        <div class="forum__swiper">
                            <ul class="forum__slider swiper-wrapper">
                                ...
                                foreach ($my_posts as $post) {
                                    setup_postdata($post);
                                    if (get_field('text_forum_ar')) :
                                ?>
                                    <li class="forum__item swiper-slide" dir="rtl"><?php the_field('text_forum_ar') ?></li>
                                <?php
                                    endif;
                                }
            ...
            <section class="speakers" id="speakers">
                <div class="container">
                    <div class="speakers__wrap">
                        <h2 class="speakers__title title">المتحدثون</h2>
        ...
        <section class="schedule" id="agenda">
            <div class="container">
                <h2 class="schedule__title title">جدول أعمال</h2>
                <div class="schedule__days">
                    <button class="schedule__day active">اليوم الأول</button>
                    <button class="schedule__day">اليوم الثاني</button>
                </div>
                <div class="schedule__wrapper">
                    <div class="schedule__content active">
                        <h3 class="schedule__subtitle">اليوم الأول - مؤتمرعالم تجربة العميل 24 يناير 2024</h3>
                        <?php
                        switch_to_blog(1);
                        query_posts('p=358'); ?>
                        <?php if (have_posts()) : ?>
                                                ...
                                                <li class="schedule__item orange">
                                                    <?php if (have_rows('accented_line')) : ?>
                                                        <?php while (have_rows('accented_line')) : the_row(); ?>
                                                            <div dir="rtl" class="schedule__time"><?php the_sub_field('accented_time'); ?></div>
                                                            <?php if (have_rows('accented_main_text')) : ?>
                                                                <?php while (have_rows('accented_main_text')) : the_row(); ?>
                                                                    <div class="schedule__event">
                                                                        <?php the_sub_field('accented_main_text_orange_ar'); ?>
                                                                        <?php if (get_sub_field('accented_main_text_black_ar')) : ?>
                                                                            <p><span><?php the_sub_field('accented_main_text_black_ar'); ?></span></p>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                <?php endwhile; ?>
                                                            <?php endif; ?>
                                                            <?php if (have_rows('accented_descr_text')) : ?>
                                                                <?php while (have_rows('accented_descr_text')) : the_row(); ?>
                                                                    <div class="schedule__descr"><?php the_sub_field('accented_descr_text_ar'); ?></div>
                                                                <?php endwhile; ?>
                                                            <?php endif; ?>
                                                        <?php endwhile; ?>
                                                    <?php endif; ?>
                                                        ...
                                                        <?php while (have_rows('default_line')) : the_row(); ?>
                                                            <?php if (have_rows('default_time_block')) : ?>
                                                                <?php while (have_rows('default_time_block')) : the_row(); ?>
                                                                    <div dir="rtl" class="schedule__time"><?php the_sub_field('default_time'); ?>
                                                                        <?php if (get_sub_field('default_time_description_ar')) : ?>
                                                                            <p><?php the_sub_field('default_time_description_ar'); ?></p>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                <?php endwhile; ?>
                                                            <?php endif; ?>
                                                            <?php if (have_rows('default_main_text')) : ?>
                                                                <?php while (have_rows('default_main_text')) : the_row(); ?>
                                                                    <div class="schedule__event">
                                                                        <?php the_sub_field('default_main_text_ar'); ?>
                                                                                ...
                                                                                <?php while (have_rows('default_text_content')) : the_row(); ?>
                                                                                    <?php if (have_rows('text_content')) : ?>
                                                                                        <?php while (have_rows('text_content')) : the_row(); ?>
                                                                                            <p>
                                                                                                <span><?php the_sub_field('text_content_bold_ar'); ?></span>
                                                                                                <?php if (get_sub_field('text_content_light_ar')) : ?>
                                                                                                    <?php the_sub_field('text_content_light_ar'); ?>
                                                                                                <?php endif; ?>
                                                                                            </p>
                                                                                        <?php endwhile; ?>
                                                                                    <?php endif; ?>
                                                            ...
                                                            <?php if (have_rows('default_descr_text')) : ?>
                                                                <?php while (have_rows('default_descr_text')) : the_row(); ?>
                                                                    <div class="schedule__descr"><?php the_sub_field('default_descr_text_ar'); ?></div>
                                                                <?php endwhile; ?>
                                                            <?php endif; ?>
                                                        <?php endwhile; ?>
                                                    <?php endif; ?>
                            ...
                            <?php endwhile; ?>
                        <?php endif; ?>
                        <button class="schedule__button" id="first-btn">مشاهدة كاملة</button>
                    </div>
                    <div class="schedule__content">
                        <h3 class="schedule__subtitle">اليوم ثانية - مؤتمرعالم تجربة العميل 25 يناير 2024</h3>
                        ...
                        <?php if (have_posts()) : ?>
                                                                                ...
                                                                                <?php if (get_sub_field('default_text_content_type') == 'var2') : ?>
                                                                                    <?php if (have_rows('list_item')) : ?>
                                                                                        <?php while (have_rows('list_item')) : the_row(); ?>
                                                                                            <p style="font-weight: 750;margin-top: 5px;">&#8226; <?php the_sub_field('list_item_ar'); ?></p>
                                                                                        <?php endwhile; ?>
                                                                                    <?php endif; ?>
                                                                                <?php endif; ?>
                                                                            <?php endwhile; ?>
                            ...
                            <?php endwhile; ?>
                        <?php endif; ?>
                        <button class="schedule__button" id="second-btn">مشاهدة كاملة</button>
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="awards-tickets-wrapper">
        <!-- <section class="awards" id="awards">
            <div class="container">
                <div class="awards__wrapper">
                    <h2 class="awards__title title">الجوائز </h2>
                ...
                <ul class="awards__list">
                    ...
                    <li class="awards__item">
                        <div class="awards__text">أفضل الأحداث التجارية</div>
                        <div class="awards__icon">
                            <svg width="48" height="49" viewBox="0 0 48 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="awards__item">
                        <div class="awards__text">أفضل قادة الأعمال</div>
                        <div class="awards__icon">
                    ...
                    <li class="awards__item">
                        <div class="awards__text">أفضل الممارسات</div>
                        <div class="awards__icon">
                            <svg width="48" height="49" viewBox="0 0 48 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="Group 107">
                    ...
                    <li class="awards__item">
                        <div class="awards__text">أفضل قاعدة معرفية</div>
                        <div class="awards__icon">
                    ...
                    <li class="awards__item awards__item--get">
        ...
        <section class="tickets" id="tickets">
            <div class="container">
                <h2 class="tickets__title title">التذاكر</h2>
                ...
                <div class="tickets__inner">
                    <div class="tickets__content">
                        <div class="tickets__box">
                            ...
                            <a class="tickets__btn" href="/ar/?add-to-cart=15">
                            التسجيل
                            </a>
                        </div>
                        <div class="tickets__box">
                            ...
                            <a class="tickets__btn" href="/ar/?add-to-cart=17">
                            الحصول على التذاكر
                            </a>
                        </div>
                        <!-- <div class="tickets__box">
                            <p class="tickets__buy-text">تذاكر سعودي أكسا 2024 الرجاء الضغط هنا</p>
                            <a class="tickets__btn" href="https://saudicxa.com/home" target="_blank">شراء تذاكر للجائزة</a>
                        </div>

                        <p class="tickets__descr">
                            مجانًا حتى 31 ديسمبر
                            <a href="#">كود خصم</a> نحتاج إلى
                        </p> -->
                    </div>
    ...
    <section class="gallery" id="galery">
        <div class="container">
            <div class="gallery__wrap">
                ...
                <h2 class="gallery__title title">معرض الصور</h2>
            </div>
        </div>
    ...
    <section class="room">
        <div class="container">
            <h2 class="room__title title">مخطط المعرض</h2>
            <div class="room__img-box">
                <img src="<?php echo bloginfo('template_url'); ?>/assets/img/room-map.png" alt="خريطة العالم CX">
            </div>
        </div>
    </section>
    <section class="news" id="news">
        <div class="container">
            <h2 class="news__title title">أحدث الأخبار</h2>
            <div class="news__swiper news-mobile swiper">
                    ...
                    ?>
                        <li class="news__item swiper-slide">
                            ...
                            <div class="news__content">
                                <h3 class="news__subtitle" dir="rtl"><?php the_field('news_title_ar'); ?></h3>
                                <div class="news__text">
                                    <p dir="rtl">
                                        <?php the_field('news_description_ar'); ?>
                                    </p>
                                </div>
            ...
            <div class="news__swiper news-desctop">
                <ul class="news__list">
                    <?php
                    switch_to_blog(1);
                    $my_posts = get_posts(array(
    ...
    <section class="partners" id="partners">
        <div class="container">
            <h2 class="partners__title title">شركاؤنا</h2>

            <div class="partners__inner">
                <div class="partners__box">
                    <div class="partners__subtitle">الرعاة الرسمين</div>
                ...
                <div class="partners__box">
                    <div class="partners__subtitle">شركاء المؤتمر</div>
                    <ul class="partners__list">
                        <li class="partners__item">
                ...
                <div class="partners__box">
                    <div class="partners__subtitle">الشركاء</div>
                    <ul class="partners__list">
                        <li class="partners__item">
    ...
    <div class="wrap">
        <section class="contact" id='feedback'>
            <div class="container">
                <h2 class="contact__title title">اتصل بنا</h2>

                <form class="contact__form" action="#" id="form">
                    <label class="contact__label">
                        <span class="sr-only">إسم العائلة</span>
                        <input class="contact__input" type="text" placeholder="إسم العائلة" name="name">
                    </label>

                    <label class="contact__label">
                        <span class="sr-only">الإسم الأول</span>
                        <input class="contact__input" type="text" placeholder="الإسم الأول" name="last-name">
                    </label>

                    <label class="contact__label">
                        <span class="sr-only">رقم الهاتف المحمول</span>
                        <input class="contact__input" type="text" placeholder="رقم الهاتف المحمول" name="mobile-number">
                    </label>

                    <label class="contact__label">
                        <span class="sr-only">البريد الإلكتروني</span>
                        <input class="contact__input" type="text" placeholder="البريد الإلكتروني" name="email">
                    </label>

                    <label class="contact__label">
                        <span class="sr-only">إسم الشركة</span>
                        <input class="contact__input" type="text" placeholder="إسم الشركة" name="company-name">
                    </label>

                    <label class="contact__label">
                        <span class="sr-only">العنوان</span>
                        <input class="contact__input" type="text" placeholder="العنوان" name="title">
                    </label>

                    <label class="contact__label-text">
                        <span class="sr-only">الوصف</span>
                        <textarea class="contact__textarea" placeholder="الوصف" rows="1" name="description"></textarea>
                    </label>

                    <button class="contact__btn" type="submit">إرسال</button>
        ...
        <section class="response hidden">
            <div class="container">
                <div class="response__wrapper">
                    <h2 class="response__title title">إعادة إرسال النموذج</h2>
                    <h3 class="response__subtitle">سيتصل بك مديرونا قريبا</h3>
                    <button class="response__btn">إعادة إرسال النموذج</button>
                </div>
            </div>
        </section>
    </div>
    <section class="location" id="location">
        <div class="container">
            <h2 class="location__title title">خريطة المكان</h2>

            <div class="location__inner">
                <div class="location__info">
                    <p class="location__place">الرياض، قاعة ذا أرينا، حي غرناطة

                    24 – 25 يناير 2024 <br>
                    <span dir="rtl">
                    06:00 صباحاً – 09:00 مساءً</span>

                    </p>
                    <!-- <p class="location__place">
                        06:00 صباحاً – 09:00 مساءً

                    </p> -->
                    <div class="location__transport">
                        <p class="location__road">طريق الامام عبدالله بن سعود بن عبدالعزيز، غرناطة، الرياض 13241</p>
                    </div>

                    <div class="location__bottom">
                        <div class="location__support">خدمة الدعم</div>
                        <a class="location__tel" href="tel:+966582970968">+966 58 297 0968</a>
                    </div>
                </div>
                <div class="location__map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3622.5147554300374!2d46.73659021376138!3d24.77782129180576!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e2efde8f1cd0b5d%3A0x4992b4380d1f29e5!2z2YLYp9i52Kkg2KfYsdmK2YbYpyDYp9mE2LHZitin2LYg2YTZhNmF2LnYp9ix2LY!5e0!3m2!1sar!2sru!4v1692605768554!5m2!1sar!2sru" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </section>
