...
<html lang="ar">
  <head>
    ...
    <meta property="og:image" content="<?php echo bloginfo('template_url');?>/assets/img/grph.jpg" />
    <meta
      property="og:description"
      content="The forum is one of the initiatives that contribute to raising the efficiency of services
    in the public and private sectors by facilitating customers."
    />
    <meta property="og:site_name" content="CX World Forum" />
    ...
    <div class="container">
        <nav class="header__nav">
            <div class="header__wrapper">
                <a href="/ar" class="header__logo"><img src="<?php echo bloginfo('template_url');?>/assets/img/logo.png" alt="logo"></a>
                <a href="/ar" class="header__sublogo"><img src="<?php echo bloginfo('template_url');?>/assets/img/sublogo.png" alt="sublogo"></a>
            </div>
            <div class="header__head">
                <a href="/"><img src="<?php echo bloginfo('template_url');?>/assets/img/logos.png" alt="logo"></a>
				...
				<ul class="header__menu">
					<li class="header__item"><a data-href="#about">عنا</a></li>
					<li class="header__item"><a data-href="#speakers">المتحدثون</a></li>
					<li class="header__item"><a data-href="#agenda">جدول الأعمال</a></li>
					<!-- <li class="header__item"><a data-href="#awards">الجوائز</a></li> -->
					<li class="header__item"><a data-href="#tickets">التذاكر</a></li>
					<li class="header__item"><a data-href="#galery">المعرض</a></li>
					<li class="header__item"><a data-href="#news">أحدث الأخبار</a></li>
					<li class="header__item"><a data-href="#partners">الشركاء والرعاة</a></li>
				</ul>
