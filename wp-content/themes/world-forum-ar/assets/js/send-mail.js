...
if(document.getElementById("form")) {
    ...
    const NAME_REGEXP = /^[a-zA-Z\u0600-\u06FF,-\s\d][\s\d\a-zA-Z\u0600-\u06FF,-]*$/g;
    ...
    form.addEventListener("submit", async function (event) {
        ...
        let response = await fetch('https://cx-world.creativecom.org/wp-content/themes/world-forum-ar/assets/mailer/mail.php', {
            method: 'POST',
