if(document.querySelector('.tribe-event-date-start')) {
    const firstDate = document.querySelector('.tribe-event-date-start');
    const secondDate = document.querySelector('.tribe-event-date-end');
    const spanEl = document.createElement("span");
    spanEl.innerHTML = "&nbsp;24 - 25 &nbsp;";
    const spanMounth = document.createElement("span");
    const spanDate = document.createElement("span");
    spanMounth.innerHTML = " يناير ";
    spanDate.innerHTML = "&nbsp; 2024";
    firstDate.innerHTML = "18:00 - 9:00 &nbsp;";
    secondDate.innerHTML = " ";
    secondDate.append(spanEl)
    
    secondDate.append(spanMounth);
    secondDate.append(spanDate);
}
