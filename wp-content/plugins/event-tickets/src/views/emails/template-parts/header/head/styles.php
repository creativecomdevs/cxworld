...
<style type="text/css">
	...
	table { width: 100% }
	table, td { border: 0; border-spacing: 0; padding: 0;}
	...
	.tec-tickets__email-table-main-header img {
		width: 80%;
		margin-top: 0;
	}
	...
	.tec-tickets__email-table-content-event-venue-address-container {
		color: #ffffff !important;
		text-align: <?php echo is_rtl() ? 'right' : 'left'; ?> !important;
	}
	.tec-tickets__email-table-content-event-venue-address-container a{
		margin-top: 20px;
	}
	.tec-tickets__email-table-content-event-venue-phone-website-container {
		display: none;
	}
	.tec-tickets__email-table-content-event-venue-address-container span.im,
	span.im,
	.im {
		color: #ffffff !important;
	}
	...
	.tec-tickets__email-table-content-event-links-table-data a{
